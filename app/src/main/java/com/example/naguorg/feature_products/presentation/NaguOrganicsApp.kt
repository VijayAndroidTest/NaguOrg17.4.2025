...
import com.example.naguorg.feature_cart.presentation.CartActivity
...
fun NaguOrganicsApp(
    ...
    Scaffold(
        ...
        Column(
            ...
            CategoryDropdown(selectedCategory = viewModel.selectedCategory) { category ->
                viewModel.loadProducts(category) // Triggers the UseCase
            }
